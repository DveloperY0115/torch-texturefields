"""
eval.py - Utility function for evaluation.
...
import evaluation.metrics.FID.fid_score as FID
import evaluation.metrics.FID.feature_l1 as feature_l1
import evaluation.metrics.SSIM_L1.ssim_l1_score as SSIM
