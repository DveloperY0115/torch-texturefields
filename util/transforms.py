"""
pointcloud_transforms.py - Transforms related to point clouds.

The following codes are brought from the official repository of Texture Fields.
"""
...
class ResizeImage(object):
    ...
    def __call__(self, img):
        img_out = resize(
            img, self.size, order=self.order, clip=False, mode="constant", anti_aliasing=False
        )
